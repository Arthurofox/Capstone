  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <AnimatedBackground positions={positions} />
        <HeroSection />
      </section>
      ...
      <section className="relative py-20 px-4">
        <CTASection setIsChatOpen={setIsChatOpen} />
      </section>
...
const AnimatedBackground = ({ positions }: { positions: Position[] }) => (
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg blur opacity-30 group-hover:opacity-100 transition duration-1000" />
...
const CTASection = ({ setIsChatOpen }: { setIsChatOpen: (open: boolean) => void }) => (
